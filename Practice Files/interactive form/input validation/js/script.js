...
const nameValidator = () => {
  // 1. Create a variable named `nameValue` to store the `.value` property of the `name` input and log the variable out to the console.
...
const emailValidator = () => {
  // 1. Create a variable named `emailValue` to store the `.value` property of the `emailAddress` input and log the variable out to the console.
