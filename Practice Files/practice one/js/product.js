...
console.log(`Current ${product.name} stock is ${product.inventory}!`);
...
const addInventory = (object, delta) => {
  object.inventory += delta;
  console.log(`${delta} ${object.name}'s added to inventory!`);
  console.log(`${product.inventory} ${object.name}'s now in stock! `);
};
...
const processSale = (object, delta) => {
  object.inventory -= delta;
  console.log(`${delta} ${object.name}'s sold`);
  console.log(`${object.inventory} ${object.name}'s now in stock!`);
  return object.unit_price * delta;
};
...
console.log(`Total sale: $${processSale(product, 9)}!`);
